                    ...
                    <div class="row">
                        <div class="col-md-6 mx-auto">
                            <div class="card">
                                ...
                                <h4 class="card-title ">Create New Area Admin</h4>
                                </div>
                                <div class="card-body text-center">
                                    <div class="row text-left">
                                        <form action="storeUser.php" method="POST" class="col-12" enctype="multipart/form-data">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <?php
                                                        ...
                                                        <?php    
                                                                ...
                                                                <option value="1">NO Area Yet</option>
                                            ...
                                            <div class="form-group">
                                                <label for="id_summon_name" class="text-left col font-weight-bold ">Admin Name</label>
                                                <div class="col">
                                                    <input type="text" name="admin_name" class="form-control" id="id_admin_value" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="admin_password" class="text-left col font-weight-bold ">Admin password</label>
                                                <div class="col">
                                                    <input type="password" name="admin_password" class="form-control" id="id_password" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="admin_email" class="text-left col font-weight-bold ">Admin email</label>
                                                <div class="col">
