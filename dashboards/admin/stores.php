                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="createStore.php" class="btn btn-info">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    ...
                                                                    while($row = mysqli_fetch_assoc($result)){
                                                                        ...
                                                                        <td>'.$row["store_manager_user_name"].'</td>
                                                                        ';
                                                                        echo '
                                                                        <td>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>This will delete Store permanently.</p>
                                <p id="test"></p>
                            </div>
                            <form action="destroyStore.php" method="POST">
                                <div class="modal-footer">
                                    <input type="hidden" id="data_summon_id" name="id" value="" required>
                                    <button type="button" class="btn btn-info" data-dismiss="modal">Close</button>
                                    <button type="submit" name="submit" class="btn btn-danger">Delete Store</button>
                                </div>
                            </form>
                        </div>
                    </div>
