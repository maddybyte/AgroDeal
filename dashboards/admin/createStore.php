                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <div class="row text-left">
                                        <form action="storeStore.php" method="POST" class="col-12" enctype="multipart/form-data">
                                            
                                            <div class="form-group">
                                                <label for="id_summon_name" class="text-left col font-weight-bold ">Store Name</label>
                                                <div class="col">
                                                    <input type="text" name="area_name" class="form-control" id="id_admin_value" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="admin_password" class="text-left col font-weight-bold ">Store Manager username (not Required)</label>
                                                <div class="col">
